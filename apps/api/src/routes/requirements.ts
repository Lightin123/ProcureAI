...
requirementsRouter.get("/", async (request, response, next) => {
  try {
...
requirementsRouter.post("/analysis", async (request, response, next) => {
  try {
    ...
    const runId = await createRun(project.id, official.id);
...
requirementsRouter.post("/", async (request, response, next) => {
  try {
    const { project } = await loadProject(routeParam(request, "projectId"));
...
requirementsRouter.patch("/:requirementId", async (request, response, next) => {
  try {
    const { official, project } = await loadProject(routeParam(request, "projectId"));
...
requirementsRouter.post("/clarifications/:questionId/answer", async (request, response, next) => {
  try {
    const { official, project } = await loadProject(routeParam(request, "projectId"));
...
requirementsRouter.post("/confirm", async (request, response, next) => {
  try {
    const { official, project } = await loadProject(routeParam(request, "projectId"));
...
requirementsRouter.post("/reopen", async (request, response, next) => {
  try {
    const { official, project } = await loadProject(routeParam(request, "projectId"));
