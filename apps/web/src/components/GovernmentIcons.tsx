...
export function AlertCircleIcon({ size = 18 }: { size?: number }) {
  return (
    <svg
      width={size}
      height={size}
...
export function PackageIcon({ size = 16 }: { size?: number }) {
  return (
    <svg
      width={size}
      height={size}
...
export function GitMergeIcon({ size = 16 }: { size?: number }) {
  return (
    <svg
      width={size}
      height={size}
...
export function ArrowUpDownIcon({ size = 14 }: { size?: number }) {
  return (
    <svg
      width={size}
      height={size}
